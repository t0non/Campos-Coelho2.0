  ...
  return (
    <div className="max-w-6xl space-y-6">
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
        <div>
          <h1 className="text-2xl font-black text-[#111111]">Clientes (Empresas)</h1>
        ...
        <div className="flex items-center gap-3">
          <div className="relative">
            ...
            <input 
              ...
              className="pl-9 pr-4 py-2 border rounded-md text-sm w-64 focus:ring-2 focus:ring-[#111111]/20 outline-none"
            />
          </div>
          ...
          <div className="relative">
            ...
            <select
              ...
              className="pl-9 pr-8 py-2 border rounded-md text-sm appearance-none bg-white focus:ring-2 focus:ring-[#111111]/20 outline-none"
            >
