        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-0 sm:divide-x divide-gray-200">
          {benefits.map((benefit) => {
            ...
            return (
              ...
              >
                <div className="w-10 h-10 shrink-0 rounded-full bg-[#f0f0f0] flex items-center justify-center shadow-2xs">
                  <Icon className="h-5 w-5 text-[#171717]" aria-hidden="true" />
                </div>
                <div>
