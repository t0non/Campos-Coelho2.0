  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background: 'linear-gradient(135deg, transparent 50%, #555555 50%)',
        }}
      />
      ...
      <div className="max-w-[1400px] mx-auto px-4 relative z-10">
        <div className="grid lg:grid-cols-12 gap-8 items-center">
          <div className="lg:col-span-8 space-y-5">
            <div className="inline-block bg-[#555555] text-white text-xs font-bold px-3 py-1 rounded-sm uppercase tracking-wider">
            ...
            <div className="grid sm:grid-cols-2 gap-2 pt-1">
              {benefits.map((b) => (
                <div key={b} className="flex items-center gap-2 text-xs font-medium text-blue-100">
                  <CheckCircle2 className="h-4 w-4 text-[#555555] shrink-0" />
                  <span>{b}</span>
                </div>
              ))}
            </div>
          ...
          <div className="lg:col-span-4 flex flex-col gap-3">
            <Link
              href="/cadastro"
              className="flex items-center justify-center gap-2 h-12 w-full rounded-sm bg-[#555555] hover:bg-[#444444] text-sm font-bold text-white transition-colors"
            >
