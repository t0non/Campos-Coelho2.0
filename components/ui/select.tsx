...
export const Select = forwardRef<HTMLSelectElement, SelectProps>(
  ({ label, error, placeholder, options, className, id, ...props }, ref) => {
    ...
    return (
      <div className="flex flex-col gap-1.5 w-full" data-field>
        {label && (
        ...
        <select
          ...
          id={selectId}
          className={cn(
            'h-11 w-full cursor-pointer rounded-lg border bg-white px-3.5 text-sm text-slate-900 transition-colors',
